      ...
      [`rows|${query.limit || 10}`]: [
        {
          ...
          category: {
            [`id|${query.categoryId == -1 ? '1-10' : query.categoryId}`]: 0,
            name: "分类@id",
          },
          "scanNumber|0-3000": 0,
          "commentNumber|0-300": 30,
          "thumb|+1": ["@image(300x250, @color, #fff, @word)", null],
          createDate: `@date('T')`,
        },
      ],
    },
...
Mock.mock("/api/comment", "post", {
  ...
  data: {
    ...
    createDate: Date.now(),
    "avatar|1": [
      "http://mdrs.yuanjin.tech/FgMwAPYq17So9nwVH44ltDHo7u3c"
    ],
  },
})
